...
const Header = () => {
 ...
 const userName=useSelector((store)=>store?.userInfo?.displayName)
  ...
  return (
    <div className=" absolute flex w-full h-16 justify-between px-2 my-2">
      <img
        src={HEADER_LOGO}
        alt="logo"
      />
   {auth.currentUser&&<div className="h-full flex items-end flex-col  basis-1/6 pt-4">
        ...
        {displaySignOut&&<div className="border border-gray-500 w-28 text-center py-4 my-2 rounded absolute top-12 bg-gray-500 ">
